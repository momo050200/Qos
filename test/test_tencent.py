...
class test(unittest.TestCase):
    ...
    def test_01_successful(self):
        ...
        #step1 获取token
        token=get_token(self,self.head_get_token)
        print('step1 获取token：'+str(token))
        #step2 申请提速
        result2 = {'result': {'Done': 'True'}}
        r=speeding_tencent(self,self.head,token,req_id='DynamicQoS')
        ...
        d=delete_speeding(self,speed_id,self.head,result4,req_id='DynamicQoS/')
