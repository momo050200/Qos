...
class test(unittest.TestCase):
    ...
    # def test_b_get_token_faile_with_none_app_id(self):
    ...
    # def test_c_get_token_faile_with_wrong_app_id(self):
    ...
    # def test_d_get_token_fail_with_app_id_not_in_system(self):
    ...
    # def test_e_get_token_faile_with_null_X_Request_At(self):
    ...
    def test_f_with_deleted_token(self):
        '''提速时，使用已撤速的token失效'''
        X_Application_id = '12345678'
        date, X_Application_Auth = MD5(X_Application_id)
        # step1 获取token
    ...
    # def test_g_with_speed_id_timeout(self):
    ...
    def test_h_token_on_timeout(self):
    ...
    def  test_k_dst_info_illegal(self):
    ...
    # def  test_l_dst_info_not_exist(self):
    ...
    def test_m_turing_success(self):
    ...
    def test_n_remove_link_and_check(self):
    ...
    def test_o_add_with_wrong_node_ip_port(self):
    ...
    def test_p_add_with_wrong_remote_ip_port(self):
    ...
    def test_q_add_with_wrong_remote_hostname(self):
    ...
    def test_r_add_with_notmatch_remote_hostname_and_remote_ip_port(self):
